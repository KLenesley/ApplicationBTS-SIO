export default function Contact() {
    return (
        <div className="flex items-center justify-center min-h-screen p-6 bg-gradient-to-r font-[family-name:var(--font-geist-sans)]">
            ...
            <button className="px-6 py-3 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 hover:shadow-xl transition duration-200 text-base sm:text-lg focus:outline-none focus:ring-4 focus:ring-blue-300">
                Commencer le Quiz
            </button>
            </main>
        </div>
