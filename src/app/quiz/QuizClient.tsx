      ...
      {currentQuestionIndex < quiz_questions.length ? (
                ...
                {quiz_answers.filter(answer => answer.question_id === question.id).map((answer, answerIndex) => (
                  <div key={answerIndex} className="flex items-center space-x-3">
                    <input
                      ...
                      value={answer.answer}
                      required
                      className="form-radio text-purple-500 focus:ring-purple-400"
                    />
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
          ...
          <button
            ...
            className="mt-6 px-5 py-2 bg-purple-600 text-white font-medium rounded-lg hover:bg-purple-700 transition"
          >
            Recommencer
          </button>
        </div>
