...
export default function Head() {
    ...
    return (
        <>
            <header className="fixed top-0 left-0 w-full bg-gradient-to-r from-gray-100 via-gray-200 to-gray-100 shadow-xl z-50">
                <nav className="max-w-7xl mx-auto px-4 py-2 flex items-center justify-between">
                    ...
                    <ul className="hidden md:flex flex-1 justify-center gap-10 items-center">
                        {navLinks.map(([label, href]) => (
                            <li key={href}>
                                <a
                                    href={href}
                                    className="text-gray-900 hover:text-green-600 font-bold px-3 py-1 rounded-lg transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-green-300"
                                >
                                    {label}
                                </a>
                            </li>
                    ...
                    <div className="hidden md:flex items-center">
                        <a
                            ...
                            className="bg-gradient-to-r from-green-500 to-green-400 hover:from-green-600 hover:to-green-500 text-white font-bold px-6 py-2 rounded-xl shadow-lg transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-green-300"
                        >
                            {userLabel}
                        </a>
                    </div>
